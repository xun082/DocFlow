        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            <label
              style={{
                ...
                cursor: 'pointer',
                padding: '0.75rem',
                background: videoEnabled ? 'rgba(14, 165, 233, 0.1)' : 'rgba(0, 0, 0, 0.05)',
                borderRadius: '12px',
            ...
            <label
              style={{
                ...
                cursor: 'pointer',
                padding: '0.75rem',
                background: audioEnabled ? 'rgba(14, 165, 233, 0.1)' : 'rgba(0, 0, 0, 0.05)',
                borderRadius: '12px',
                transition: 'background 0.2s',
              }}
            >
          ...
          <button
            ...
            style={{
              ...
              transition: 'all 0.2s',
              boxShadow:
                isJoining || !username.trim() ? 'none' : '0 4px 15px rgba(14, 165, 233, 0.4)',
            }}
          >
