  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium text-purple-700 bg-purple-100/80 hover:bg-purple-200/80 transition-all duration-200 border border-purple-300/50"
          disabled={disabled}
        >
        ...
        {loading ? (
          ...
          models.map((model) => (
            <DropdownMenuItem
              ...
              className={cn('cursor-pointer', selectedModel === model.id && 'bg-purple-50')}
            >
