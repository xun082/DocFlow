              ...
              <Button variant="ghost" className="relative h-10 w-auto px-2 hover:bg-gray-100">
                <div className="flex items-center space-x-2">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src={user?.avatar_url || ''} alt={user?.name || '用户'} />
                  ...
                  <div className="hidden md:flex flex-col items-start">
                    ...
                    <span className="text-xs text-gray-500">{user?.role || '用户'}</span>
                  </div>
            ...
            <DropdownMenuContent align="end" className="w-64">
              <DropdownMenuLabel className="pb-2">
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-gray-500">{user?.email || '暂无邮箱'}</p>
              ...
              <DropdownMenuItem asChild>
                <Link href="/dashboard/settings" className="flex items-center py-2 cursor-pointer">
